use crate::{
    ...
    evaluator::{EvalExpression, EvalResult},
};

use super::{
    super::{Evaluator, Statement},
        ...
        match statement {
            ...
            Statement::DeclareArray(var, size) => {
                ...
                if let EvalResult::Number(size) = size {
                    ...
                    return Err(PseudoError::AssignmentError(
            ...
            _ => {
                return Err(PseudoError::StatementError(
                    "Invalid array statement".to_string(),
                ))
            }
        }
    }
